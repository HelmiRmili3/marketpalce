...
export const auth0 = require("../smartContracts/auth0.json");
...
export const MedicalDataNFT = require("../smartContracts/MedicalDataNFT.json");
...
export const Composable = require("../smartContracts/Composable.json");
